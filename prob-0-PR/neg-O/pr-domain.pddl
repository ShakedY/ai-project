(define
	...
	(:predicates
		...
		( EXPLAINED_RECON_LEO_1 )
		( EXPLAINED_BREAK-INTO_LEO_1 )
		( EXPLAINED_MODIFY-FILES_LEO_1 )
		( EXPLAINED_CLEAN_LEO_1 )
		( EXPLAINED_RECON_TAURUS_1 )
		( EXPLAINED_BREAK-INTO_TAURUS_1 )
		( EXPLAINED_MODIFY-FILES_TAURUS_1 )
		( EXPLAINED_CLEAN_TAURUS_1 )
		( EXPLAINED_RECON_PERSEUS_1 )
		( EXPLAINED_BREAK-INTO_PERSEUS_1 )
		( EXPLAINED_MODIFY-FILES_PERSEUS_1 )
		( EXPLAINED_CLEAN_PERSEUS_1 )
		( NOT_EXPLAINED_RECON_LEO_1 )
		( NOT_EXPLAINED_BREAK-INTO_LEO_1 )
		( NOT_EXPLAINED_MODIFY-FILES_LEO_1 )
		( NOT_EXPLAINED_CLEAN_LEO_1 )
		...
		( NOT_EXPLAINED_RECON_PERSEUS_1 )
		( NOT_EXPLAINED_BREAK-INTO_PERSEUS_1 )
		( NOT_EXPLAINED_MODIFY-FILES_PERSEUS_1 )
		( NOT_EXPLAINED_CLEAN_PERSEUS_1 )
		( EXPLAINED_FULL_OBS_SEQUENCE )
		( NOT_EXPLAINED_FULL_OBS_SEQUENCE )
	) 
	(:functions (total-cost))
	(:action EXPLAIN_OBS_RECON_LEO_1
		:parameters ()
		:precondition
		(and
		)
		...
		(and
			...
			( RECON-PERFORMED_LEO )
			 ( EXPLAINED_RECON_LEO_1 )
			 (not ( NOT_EXPLAINED_RECON_LEO_1 ))
		)
	)
	(:action EXPLAIN_OBS_BREAK-INTO_LEO_1
		:parameters ()
		:precondition
		(and
			( RECON-PERFORMED_LEO )
		...
		(and
			...
			( ACCESS-OBTAINED_LEO )
			 ( EXPLAINED_BREAK-INTO_LEO_1 )
			 (not ( NOT_EXPLAINED_BREAK-INTO_LEO_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_MODIFY-FILES_LEO_1
		:parameters ()
		:precondition
		(and
			( ACCESS-OBTAINED_LEO )
		...
		(and
			...
			( MODIFIED-FILES_LEO )
			 ( EXPLAINED_MODIFY-FILES_LEO_1 )
			 (not ( NOT_EXPLAINED_MODIFY-FILES_LEO_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_CLEAN_LEO_1
		:parameters ()
		:precondition
		(and
			( ACCESS-OBTAINED_LEO )
	...
	(:action EXPLAIN_OBS_RECON_PERSEUS_1
		:parameters ()
		:precondition
		(and
			( EXPLAINED_CLEAN_TAURUS_1 )
		...
		(and
			...
			( RECON-PERFORMED_PERSEUS )
			 ( EXPLAINED_RECON_PERSEUS_1 )
			 (not ( NOT_EXPLAINED_RECON_PERSEUS_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_BREAK-INTO_PERSEUS_1
		:parameters ()
		:precondition
		(and
			( RECON-PERFORMED_PERSEUS )
		...
		(and
			...
			( ACCESS-OBTAINED_PERSEUS )
			 ( EXPLAINED_BREAK-INTO_PERSEUS_1 )
			 (not ( NOT_EXPLAINED_BREAK-INTO_PERSEUS_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_MODIFY-FILES_PERSEUS_1
		:parameters ()
		:precondition
		(and
			( ACCESS-OBTAINED_PERSEUS )
		...
		(and
			...
			( MODIFIED-FILES_PERSEUS )
			 ( EXPLAINED_MODIFY-FILES_PERSEUS_1 )
			 (not ( NOT_EXPLAINED_MODIFY-FILES_PERSEUS_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_CLEAN_PERSEUS_1
		:parameters ()
		:precondition
		(and
			( ACCESS-OBTAINED_PERSEUS )
		...
		(and
			...
			( DELETED-LOGS_PERSEUS )
			 ( EXPLAINED_CLEAN_PERSEUS_1 )
			 ( EXPLAINED_FULL_OBS_SEQUENCE )
			 (not ( NOT_EXPLAINED_CLEAN_PERSEUS_1 ))
